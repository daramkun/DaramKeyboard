...
class QwertySymbolLayout private constructor(val page: Int) : KeyboardLayout {

    companion object {
        val Page1 = QwertySymbolLayout(0)
        val Page2 = QwertySymbolLayout(1)
        val Page3 = QwertySymbolLayout(2)
        ...
        fun nextPage(current: QwertySymbolLayout) = page((current.page + 1) % 3)
    }
